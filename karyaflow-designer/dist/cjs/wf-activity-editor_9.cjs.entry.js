...
const ActivityEditor = class {
    constructor(hostRef) {
        ...
        this.submit = index.createEvent(this, "update_activity", 7);
    ...
    render() {
        ...
        return (index.h("div", null, index.h("div", { class: "modal", tabindex: "-1", role: "dialog" }, index.h("div", { class: "modal-dialog modal-xl", role: "document" }, index.h("div", { class: "modal-content" }, index.h("form", { onSubmit: e => this.onSubmit(e) }, index.h("div", { class: "modal-header" }, index.h("h5", { class: "modal-title" }, "Edit ", displayName), index.h("button", { type: "button", class: "close", "data-dismiss": "modal", "aria-label": "Close" }, index.h("span", { "aria-hidden": "true" }, "\u00D7"))), index.h("div", { class: "modal-body" }, index.h("wf-activity-renderer", { activity: activity, activityDefinition: activityDefinition, displayMode: ActivityDisplayMode.Edit, ref: x => this.renderer = x })), index.h("div", { class: "modal-footer" }, index.h("button", { type: "button", class: "btn btn-secondary", "data-dismiss": "modal" }, "Cancel"), index.h("button", { type: "submit", class: "btn btn-primary" }, "Save"))))))));
    }
...
const ActivityPicker = class {
    constructor(hostRef) {
        index.registerInstance(this, hostRef);
        this.activitySelected = index.createEvent(this, "activity_picked", 7);
        this.activityDefinitions = [];
        this.filterText = '';
        ...
        this.renderActivity = (activity) => {
            ...
            return (index.h("div", { class: "card activity" }, index.h("div", { class: "card-body" }, index.h("h4", { class: "card-title" }, index.h("i", { class: iconClass }), activity.displayName), index.h("p", null, activity.description), index.h("a", { href: "#", onClick: e => {
                    e.preventDefault();
                    this.selectCategory(activity.category);
                } }, index.h("span", { class: "badge badge-light" }, activity.category))), index.h("div", { class: "card-footer text-muted text-xs-right" }, index.h("a", { class: "btn btn-primary btn-sm", href: "#", onClick: async (e) => {
                    e.preventDefault();
    ...
    render() {
        ...
        return (index.h("div", null, index.h("div", { class: "modal", tabindex: "-1", role: "dialog", ref: el => this.modal = el }, index.h("div", { class: "modal-dialog modal-xl", role: "document" }, index.h("div", { class: "modal-content" }, index.h("div", { class: "modal-header" }, index.h("h5", { class: "modal-title" }, "Available Activities"), index.h("button", { type: "button", class: "close", "data-dismiss": "modal", "aria-label": "Close" }, index.h("span", { "aria-hidden": "true" }, "\u00D7"))), index.h("div", { class: "modal-body" }, index.h("div", { class: "row" }, index.h("div", { class: "col-sm-3 col-md-3 col-lg-2" }, index.h("div", { class: "form-group" }, index.h("input", { class: "form-control", type: "search", placeholder: "Filter", "aria-label": "Filter", autofocus: true, onKeyUp: this.onFilterTextChanged })), index.h("ul", { class: "nav nav-pills flex-column activity-picker-categories" }, categories.map(category => {
            ...
            return (index.h("li", { class: "nav-item" }, index.h("a", { class: classes, href: "#", "data-toggle": "pill", onClick: e => {
                    e.preventDefault();
                    this.selectCategory(category);
                } }, categoryDisplayText)));
        }))), index.h("div", { class: "col-sm-9 col-md-9 col-lg-10" }, index.h("div", { class: "card-columns tab-content" }, definitions.map(this.renderActivity))))), index.h("div", { class: "modal-footer" }, index.h("button", { type: "button", class: "btn btn-secondary", "data-dismiss": "modal" }, "Cancel")))))));
    }
    get el() { return index.getElement(this); }
};
...
const ActivityRenderer = class {
    ...
    renderDesigner() {
        ...
        const result = ActivityManager$1.renderDesigner(activity, definition);
        const iconClass = `${result.icon} mr-1`;
        return (index.h("div", null, index.h("h5", null, index.h("i", { class: iconClass }), result.title), index.h("p", { innerHTML: result.description })));
    }
    renderEditor() {
        const activity = this.activity;
        const definition = this.activityDefinition;
        const properties = definition.properties;
        return (index.h(index.Host, null, properties.map(property => {
            const html = DisplayManager$1.displayEditor(activity, property);
            return index.h("div", { class: "form-group", innerHTML: html });
        })));
    }
...
const ContextMenu = class {
    constructor(hostRef) {
        index.registerInstance(this, hostRef);
        this.contextMenuEvent = index.createEvent(this, "context_menu", 7);
        this.isHidden = true;
    ...
    render() {
        ...
        return (index.h(index.Host, { class: "dropdown-menu context-menu canvas-context-menu position-fixed", style: css, onClick: this.onContextMenuClick }, index.h("slot", null)));
    }
    setupTarget(value) {
        if (!!value) {
...
const ContextMenuItem = class {
    ...
    render() {
        ...
        return (index.h("a", { class: "dropdown-item", href: "#", onClick: e => e.preventDefault() }, text));
    }
    get el() { return index.getElement(this); }
};
...
// --------------------------- jsPlumbInstance public API ---------------------------------------------------------
        ...
        var _set = function (c, el, idx, doNotRepaint) {
            var ep, _st = stTypes[idx], cId = c[_st.elId], sid, sep,
...
const Designer = class {
    constructor(hostRef) {
        index.registerInstance(this, hostRef);
        this.editActivityEvent = index.createEvent(this, "edit_activity", 7);
        this.addActivityEvent = index.createEvent(this, "add_activity", 7);
        this.workflowChanged = index.createEvent(this, "workflowChanged", 7);
        this.activityDefinitions = [];
        this.workflow = {
            activities: [],
            connections: []
        ...
        this.renderContextMenu = () => {
            ...
            return ([
                ...
                // </wf-context-menu>,
                // <wf-context-menu target={this.elem()}>
                //   <wf-context-menu-item text="Add Activity" onClick={this.}/>
                // </wf-context-menu>,
                index.h("wf-context-menu", { ref: (el) => this.activityContextMenu = el }, index.h("wf-context-menu-item", { text: "Delete", onClick: this.onDeleteActivityClick }))
            ]);
        };
    ...
    render() {
        ...
        return (index.h("host", { class: "workflow-canvas", ref: el => this.canvas = el, style: { height: this.canvasHeight } }, activities.map((model) => {
            ...
            if (!this.readonly) {
                return (index.h("div", { id: `wf-activity-${activity.id}`, "data-activity-id": activity.id, class: classes, style: styles, onDblClick: () => this.onEditActivity(activity), onContextMenu: (e) => this.onActivityContextMenu(e, activity) }, index.h("wf-activity-renderer", { activity: activity, activityDefinition: model.definition, displayMode: ActivityDisplayMode.Design })));
            }
            else {
                ...
                return (index.h("div", Object.assign({ id: `wf-activity-${activity.id}`, "data-activity-id": activity.id, class: classes, style: styles }, popoverAttributes), index.h("wf-activity-renderer", { activity: activity, activityDefinition: model.definition, displayMode: ActivityDisplayMode.Design })));
            }
        }), this.renderContextMenu()));
    }
    ...
    setupOutcomes(element) {
        ...
        const outcomes = ActivityManager$1.getOutcomes(activity, definition);
...
const DesignerHost = class {
    ...
    render() {
        const activityDefinitions = this.activityDefinitions;
        return (index.h("host", null, index.h("wf-activity-picker", { activityDefinitions: activityDefinitions, ref: el => this.activityPicker = el }), index.h("wf-activity-editor", { activityDefinitions: activityDefinitions, ref: el => this.activityEditor = el }), index.h("wf-import-export", { ref: el => this.importExport = el }), index.h("div", { class: "workflow-designer-wrapper dragscroll" }, index.h("wf-designer", { activityDefinitions: activityDefinitions, ref: el => this.designer = el, canvasHeight: this.canvasHeight, workflow: this.workflow, readonly: this.readonly, onWorkflowChanged: this.onWorkflowChanged }))));
    }
    get el() { return index.getElement(this); }
};
...
const ExportButton = class {
    constructor(hostRef) {
        index.registerInstance(this, hostRef);
        this.exportClickedEvent = index.createEvent(this, "export", 7);
    ...
    render() {
        ...
        return (index.h("div", { class: "dropdown" }, index.h("button", { class: "btn btn-secondary dropdown-toggle", type: "button", id: "exportButton", "data-toggle": "dropdown", "aria-haspopup": "true", "aria-expanded": "false" }, "Export"), index.h("div", { class: "dropdown-menu", "aria-labelledby": "exportButton" }, Object.keys(descriptors).map(key => {
            const descriptor = descriptors[key];
            return (index.h("a", { class: "dropdown-item", href: "#", onClick: e => this.handleExportClick(e, descriptor) }, descriptor.displayName));
        }))));
    }
    get el() { return index.getElement(this); }
};
...
const ImportExport = class {
    constructor(hostRef) {
        index.registerInstance(this, hostRef);
        this.importEvent = index.createEvent(this, "import_workflow", 7);
        this.importWorkflow = () => {
    ...
    render() {
        return (index.h("host", null, index.h("input", { type: "file", class: "import-button", onChange: this.importWorkflow, ref: el => this.fileInput = el })));
    }
    get el() { return index.getElement(this); }
};
ImportExport.style = importExportCss;

exports.wf_activity_editor = ActivityEditor;
exports.wf_activity_picker = ActivityPicker;
exports.wf_activity_renderer = ActivityRenderer;
exports.wf_context_menu = ContextMenu;
exports.wf_context_menu_item = ContextMenuItem;
exports.wf_designer = Designer;
exports.wf_designer_host = DesignerHost;
exports.wf_export_button = ExportButton;
exports.wf_import_export = ImportExport;
