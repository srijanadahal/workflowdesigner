...
import { r as registerInstance, c as createEvent, h, g as getElement, H as Host } from './index-2a5a73f0.js';
...
var activityEditorCss = "";
var ActivityEditor = /** @class */ (function () {
    function class_1(hostRef) {
        registerInstance(this, hostRef);
        this.submit = createEvent(this, "update_activity", 7);
        this.activityDefinitions = [];
    }
    class_1.prototype.onSubmit = function (e) {
...
var activityPickerCss = "";
var ActivityPicker = /** @class */ (function () {
    function class_2(hostRef) {
        var _this_1 = this;
        registerInstance(this, hostRef);
        this.activitySelected = createEvent(this, "activity_picked", 7);
        this.activityDefinitions = [];
        this.filterText = '';
    ...
    class_2.prototype.onActivitySelected = function (activity) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
    ...
    class_2.prototype.render = function () {
        ...
        var categories = __spreadArrays([null], new Set(activities.map(function (x) { return x.category; })));
...
var ActivityRenderer = /** @class */ (function () {
    ...
    class_3.prototype.renderDesigner = function () {
        var activity = this.activity;
    ...
    class_3.prototype.renderEditor = function () {
        var activity = this.activity;
        var definition = this.activityDefinition;
    ...
    class_3.prototype.updateEditor = function (formData) {
        return __awaiter(this, void 0, void 0, function () {
...
var ContextMenu = /** @class */ (function () {
    function class_4(hostRef) {
        var _this_1 = this;
        registerInstance(this, hostRef);
        this.contextMenuEvent = createEvent(this, "context_menu", 7);
        this.isHidden = true;
    ...
    class_4.prototype.targetChangeHandler = function (newValue, oldValue) {
        if (!!oldValue) {
            oldValue.removeEventListener('contextmenu', this.onContextMenu);
        }
        this.setupTarget(newValue);
    };
    class_4.prototype.targetSelectorChangeHandler = function (newValue) {
        this.target = document.querySelector(newValue);
    };
    class_4.prototype.handleBodyClick = function () {
        this.isHidden = true;
    };
    class_4.prototype.handleContextMenu = function () {
        this.isHidden = true;
    };
    class_4.prototype.handleContextMenuEvent = function (e) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_b) {
    ...
    class_4.prototype.setupTarget = function (value) {
        if (!!value) {
...
var jsplumb = createCommonjsModule(function (module, exports) {
    ...
    (function () {
        ...
        var Drag = function (el, params, css, scope) {
            ...
            var downAt = [0, 0], posAtDown = null, pagePosAtDown = null, pageDelta = [0, 0], moving = false, initialScroll = [0, 0], consumeStartEvent = this.params.consumeStartEvent !== false, dragEl = this.el, clone = this.params.clone, _multipleDrop = params.multipleDrop !== false, isConstrained = false, 
            //useGhostProxy = params.ghostProxy === true ? TRUE : params.ghostProxy && typeof params.ghostProxy === "function" ? params.ghostProxy : FALSE,
            useGhostProxy, ghostProxy, // = function(el) { return el.cloneNode(true); },
            elementToDrag = null, availableSelectors = [], activeSelectorParams = null, // which, if any, selector config is currently active.
        ...
        var jsPlumbInstance = root.jsPlumbInstance = function (_defaults) {
            ...
            this.addEndpoint = function (el, params, referenceParams) {
                ...
                for (var i = 0, j = inputs.length; i < j; i++) {
                    ...
                    if (!_suspendDrawing) {
                        e.paint({
                            anchorLoc: e.anchor.compute({ xy: [myOffset.left, myOffset.top],
                                wh: sizes[id],
                                element: e,
    ...
    (function () {
            ...
            placeAnchors = function (elementId, _anchorLists) {
                var cd = jsPlumbInstance.getCachedData(elementId), sS = cd.s, sO = cd.o, placeSomeAnchors = function (desc, elementDimensions, elementPosition, unsortedConnections, isHorizontal, otherMultiplier, orientation) {
                    if (unsortedConnections.length > 0) {
                        ...
                        reverse = desc === "right" || desc === "top", rotation = jsPlumbInstance.getRotation(elementId), anchors = placeAnchorsOnLine(desc, elementDimensions, elementPosition, sc, isHorizontal, otherMultiplier, reverse, rotation);
        ...
        _jp.DynamicAnchor = function (params) {
            ...
            var _curAnchor = this.anchors.length > 0 ? this.anchors[0] : null, _lastAnchor = _curAnchor, 
            ...
            function _updateConnectionsForGroup(group) {
                ...
                var oneSet = function (c) {
                    for (var i = 0; i < c.length; i++) {
                        ...
                        var gs = _jsPlumb.getGroupFor(c[i].source), gt = _jsPlumb.getGroupFor(c[i].target);
                        if (gs === group) {
                            if (gt !== group) {
    ...
    (function () {
        ...
        var Flowchart = function (params) {
            ...
            var segments, _super = _jp.Connectors.AbstractConnector.apply(this, arguments), midpoint = params.midpoint == null || isNaN(params.midpoint) ? 0.5 : params.midpoint, alwaysRespectStubs = params.alwaysRespectStubs === true, lastx = null, lasty = null, cornerRadius = params.cornerRadius != null ? params.cornerRadius : 0, sgn = function (n) {
...
var Designer = /** @class */ (function () {
    function class_5(hostRef) {
        ...
        this.renderContextMenu = function () {
            ...
            return ([
                ...
                // </wf-context-menu>,
                h("wf-context-menu", { ref: function (el) { return _this_1.activityContextMenu = el; } }, h("wf-context-menu-item", { text: "Delete", onClick: _this_1.onDeleteActivityClick }))
            ]);
        };
        this.deleteActivity = function (activity) { return __awaiter(_this_1, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                ...
                this.workflow = Object.assign(Object.assign({}, this.workflow), { activities: activities, connections: connections });
                return [2 /*return*/];
            });
        }); };
        ...
        this.updateActivityInternal = function (activity) { return __awaiter(_this_1, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                activities = __spreadArrays(this.workflow.activities);
                index = activities.findIndex(function (x) { return x.id == activity.id; });
                activities[index] = Object.assign({}, activity);
                this.workflow = Object.assign(Object.assign({}, this.workflow), { activities: activities });
                return [2 /*return*/];
            });
        }); };
        ...
        this.connectionCreated = function (info) { return __awaiter(_this_1, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                ...
                if (!wfConnection) {
                    connections = __spreadArrays(this.workflow.connections, [{
                            sourceActivityId: sourceActivity.id,
                            destinationActivityId: destinationActivity.id,
                            outcome: outcome
                        }]);
                    this.workflow = Object.assign(Object.assign({}, this.workflow), { connections: connections });
                }
                return [2 /*return*/];
            });
        }); };
    ...
    class_5.prototype.onWorkflowChanged = function (value) {
        this.workflowChanged.emit(deepClone(value));
    };
    class_5.prototype.newWorkflow = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_b) {
                this.workflow = {
                    activities: [],
    ...
    class_5.prototype.getWorkflow = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_b) {
                debugger;
    ...
    class_5.prototype.addActivity = function (activityDefinition) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                ...
                this.lastClickedLocation = null;
                activities = __spreadArrays(this.workflow.activities, [activity]);
                this.workflow = Object.assign(Object.assign({}, this.workflow), { activities: activities });
                return [2 /*return*/];
            });
        });
    };
    class_5.prototype.updateActivity = function (activity) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_b) {
                switch (_b.label) {
    ...
    class_5.prototype.componentDidRender = function () {
        this.setupJsPlumb();
        this.setupPopovers();
    };
    ...
    class_5.prototype.createActivityModels = function () {
    ...
    class_5.prototype.setupTargets = function (element) {
    ...
    class_5.prototype.setupOutcomes = function (element) {
    ...
    class_5.prototype.getActivityElements = function () {
        return this.elem().querySelectorAll(".activity");
    };
    class_5.getActivityId = function (element) {
        return element.attributes['data-activity-id'].value;
    };
    class_5.prototype.onEditActivity = function (activity) {
        var clone = deepClone(activity);
        this.editActivityEvent.emit(clone);
    };
    class_5.prototype.onActivityContextMenu = function (e, activity) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
...
var ExpressionFieldDriver = /** @class */ (function () {
    function ExpressionFieldDriver() {
        this.displayEditor = function (activity, property) {
            var name = property.name;
            var label = property.label;
            var value = activity.state[name] || { expression: '', syntax: 'Literal' };
...
var WorkflowPluginStore = /** @class */ (function () {
    function WorkflowPluginStore() {
        ...
        this.add = function (plugin) {
            _this_1.plugins = __spreadArrays(_this_1.plugins, [plugin]);
        };
        this.list = function () { return __spreadArrays(_this_1.plugins); };
    }
...
var designerHostCss = ".workflow-designer-wrapper{height:80vh;overflow-y:auto}";
var DesignerHost = /** @class */ (function () {
    function class_6(hostRef) {
        ...
        this.initActivityDefinitions = function () {
            ...
            if (!!_this_1.activityDefinitionsData) {
                ...
                _this_1.activityDefinitions = __spreadArrays(_this_1.activityDefinitions, definitions);
            }
        };
    ...
    class_6.prototype.newWorkflow = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_b) {
                switch (_b.label) {
    ...
    class_6.prototype.getWorkflow = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_b) {
                switch (_b.label) {
    ...
    class_6.prototype.showActivityPicker = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_b) {
                switch (_b.label) {
    ...
    class_6.prototype.export = function (formatDescriptor) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_b) {
                switch (_b.label) {
    ...
    class_6.prototype.import = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_b) {
                switch (_b.label) {
    ...
    class_6.prototype.onActivityPicked = function (e) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_b) {
                switch (_b.label) {
    ...
    class_6.prototype.onEditActivity = function (e) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_b) {
    ...
    class_6.prototype.onAddActivity = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_b) {
                switch (_b.label) {
    ...
    class_6.prototype.onUpdateActivity = function (e) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_b) {
                switch (_b.label) {
    ...
    class_6.prototype.onExportWorkflow = function (e) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
    ...
    class_6.prototype.onImportWorkflow = function (e) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_b) {
...
var importExportCss = ".import-button{display:none}";
var ImportExport = /** @class */ (function () {
    function class_8(hostRef) {
        var _this_1 = this;
        registerInstance(this, hostRef);
        this.importEvent = createEvent(this, "import_workflow", 7);
    ...
    class_8.prototype.export = function (designer, formatDescriptor) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    class_8.prototype.import = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            var workflow;
            return __generator(this, function (_b) {
                if (!data) {
